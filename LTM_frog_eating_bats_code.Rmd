---
title: "Long term memory in frog-eating bats code"
author: "M. May Dixon"
date: "3/3/2022"
...
Make dataset where response scores to Primary are calculated as the maximum response to A or B: 
```{r}
...
```{r}
# Did experienced bats respond differently to the treatment vs extinguished treatments? 
...
#best to use two-tailed, bc would be interesting/ possible, if odd, for experienced bats to have higher responses to static
